...
| Desktop verification | All 26 material/texture/state/camera/post CTests and 22 source guards pass; 3615 matching authored flare-sprite and 5142 bloom checks; corrected visible flare preview inspected in both eyes; final normal flat/VR captures have 0/119 large jumps and correctly crossed first/last VR depth | Distant VR blur, per-eye flare optics and character-shadow/full-game coverage remain unqualified; the earlier late-scene failure (110/119 large changes) is not superseded |
