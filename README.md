...
| Desktop verification | All 25 material/texture/state/camera/output CTests and thirteen source guards pass; latest normal flat and scoped-camera VR sequences have 0/119 large jumps; both first/last VR eye checks show correctly crossed depth | Distant VR scenery remains blurred, and character-shadow/full-game coverage is unqualified. Last late-scene check still fails (110/119 large frame changes); this short checkpoint does not supersede that failure |
