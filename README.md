...
| Native sun camera (experimental) | Native orthographic fit, snapshot and sun-volume culling; scoped removal of an obsolete character light-eye cutoff restores Shu's shadow in the normal short flat sequence (0/119 large jumps) | **Disabled by default:** final-eye qualification remains; the diagnostic run flagged two transitions. Complete character submission, other shadow modes and broader coverage remain |
